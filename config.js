...
module.exports = {
  ...
  ALIVE_DATA : process.env.ALIVE_DATA || "_*Hy &sender LEVEL SAB KE NIKLE GE*_\n\n_PLATFORM: &platform_\n_RUNTIME : &runtime_\n\n_. type alive to update your alive message_",
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'LUCIFER DEVIL👿👿😈😈; LUCIFER DEVIL',
  ...
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME |LUCIYA MD RETURN| '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY |WDRR97WM| '',
